	...
	if(isset($_SESSION['user']))
	{
		...
		if($query_insert_obj !== FALSE)
		{
			...
			if($result_execution)
			{
				...
				header("location: http://sistemaswebsimonebrazzo.hol.es/Lab4Seguridad/InsertarPregunta.php?insert=ok");	
			
			}
			else
				header("location: http://sistemaswebsimonebrazzo.hol.es/Lab4Seguridad/InsertarPregunta.php?insert=ko");
